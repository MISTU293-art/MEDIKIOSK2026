...
router.post('/patients', doctorController.postCreatePatient);
router.get('/reports', doctorController.getReports);
router.post('/reports', doctorController.postRequestReport);
...
router.post('/assistant', doctorController.postAssistant);
